...
from wersav.public.forms import LoginForm
from wersav.user.forms import RegisterForm
from wersav.user.models import User
from wersav.utils import flash_errors
...
def static_proxy(filename):
    """Send static files from the staticuploads folder."""
